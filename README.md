...
Acceptance tests cover api endpoints and ensure requests are wired up correctly. This means checking status codes, response formats, and basic request validation. It doesn't meaningfully test business logic.
